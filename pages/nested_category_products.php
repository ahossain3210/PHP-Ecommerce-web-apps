    ...
    <div class="wrap">
        <div class="rsidebar span_1_of_left">
            <section  class="sky-form" id="sidebar_accordion">
                <h4 class="m_top_0 p_top_0 tt_uppercase color_light t_align_c f_weight_b">Category</h4>
                    <div id="sidebar_cat">
                        <?php 
        ...
        <div class="cont span_2_of_3">
            ...
            <div class="box1">
                <?php
                $nid=$_GET['nid'];
                $nested_product=$obj_app->select_nested_category_product_info($nid);
                
                while ($nested_product_info=  mysqli_fetch_assoc($nested_product))
                    {
                ?>
                <div class="col_1_of_single1 span_1_of_single1">
                        <div class="view1 view-fifth1">
                            <div class="top_box">
                                <a href="product_details.php?product_id=<?php echo $nested_product_info['product_id'];?>">
                                <h3 class="m_1"><?php echo $nested_product_info['product_name'];?></h3>
                                <p class="m_2"><?php echo $nested_product_info['manufacturer_name'];?></p>
                                <div class="grid_img">
                                    <div class="css3"><img src="assets/<?php echo $nested_product_info['product_image'];?>" width="100%" height="200" alt=""/></div>
                                    <div class="mask1">
                                        <div class="info">Quick View</div>
                                    </div>
                                </div>
                                </a>
                                <p class="price scheme_color f_size_14">Tk.<?php echo $nested_product_info['product_price'];?> <span class="color_dark m_left_10" style="font-size:13px;"><small><s>Tk.<?php echo $nested_product_info['product_p_price'];?></s></small></span></p>
                            </div>
                        </div>
                        <span class="rating1">

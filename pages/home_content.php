...
$mobile_result = $obj_app->select_mobile_info();

//..........Punjabi Collection.............

$punjabi_result = $obj_app->select_punjabi_info();
...
{
    $obj_app->select_search_product_info($_POST);
}
                    ...
                    <article style="position: relative; width: 100%; opacity: 1;"> 
                        <div class="banner-wrap">
                            ...
                            <div class="slider-right">
                                ...
                                <div class="btn"><a href="product_details.php?product_id=<?php echo $product_info['product_id']; ?>">Shop Now</a></div>
                            </div>
                            <div class="clear"></div>
                        </div>
                    </article>
...
<div class="login">  
    <div class="wrap">
        ...
        <div class="cont span_2_of_3">
            ...
            <div class="mens-toolbar m_top_25">
                <h3 class="tt_uppercase color_dark f_weight_b t_align_c">Mobile Collections</h3>
            </div>
            <div class="box1">
                <?php while ($product_info = mysqli_fetch_assoc($mobile_result)){?>
                    <div class="col_1_of_single1 span_1_of_single1">
                        <div class="view1 view-fifth1">
                            <div class="top_box">
                                <a href="product_details.php?product_id=<?php echo $product_info['product_id']; ?>">
            ...
            <div class="mens-toolbar m_top_25">
                <h3 class="tt_uppercase color_dark f_weight_b t_align_c">Punjabi Collections</h3>
            </div>
            <div class="box1">
                <?php while ($product_info = mysqli_fetch_assoc($punjabi_result)){?>
                    <div class="col_1_of_single1 span_1_of_single1">
                        <div class="view1 view-fifth1">
                            <div class="top_box">
                                <a href="product_details.php?product_id=<?php echo $product_info['product_id']; ?>">

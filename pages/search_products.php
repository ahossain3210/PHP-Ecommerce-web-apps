...
{
    $search_result=$obj_app->select_search_product_info();
}
?>
<div class="login">  
    <div class="wrap">
                    ...
                    <div id="sidebar_cat">
                        ...
                        <div class="cat_item">
                            ...
                            <ul class="active">
                                ...
                                {
                                ?>
                                <li><a href="nested_category_products.php?nested_category_id=<?php echo $nested_category_info['nested_category_id'];?>"><?php echo $nested_category_info['nested_category_name'];?></a></li>
                                <?php }?>
                            </ul>
                        </div>
                        <?php }?>
        ...
        <div class="cont span_2_of_3">
            ...
            <div class="box1">
                <?php while ($product_info=mysqli_fetch_assoc($search_result)){?>

...
$category_product=$obj_app->select_category_product_info($category_id);
...
<div class="login">  
    <div class="wrap">
        ...
        <div class="cont span_2_of_3">
            ...
            <div class="box1">
                <?php while ($category_product_info=  mysqli_fetch_assoc($category_product)){?>
                <div class="col_1_of_single1 span_1_of_single1">
                        <div class="view1 view-fifth1">
                            <div class="top_box">
                                <a href="product_details.php?product_id=<?php echo $category_product_info['product_id'];?>">
                                <h3 class="m_1"><?php echo $category_product_info['product_name'];?></h3>
                                <p class="m_2"><?php echo $category_product_info['manufacturer_name'];?></p>
                                <div class="grid_img">
                                    <div class="css3"><img src="assets/<?php echo $category_product_info['product_image'];?>" width="100%" height="200" alt=""/></div>
                                    <div class="mask1">
                                        <div class="info">Quick View</div>
                                    </div>
                                </div>
                                </a>
                                <p class="price scheme_color f_size_14">Tk.<?php echo $category_product_info['product_price'];?> <span class="color_dark m_left_10" style="font-size:13px;"><small><s>Tk.<?php echo $category_product_info['product_p_price'];?></s></small></span></p>
                            </div>
                        </div>
                        <span class="rating1">
